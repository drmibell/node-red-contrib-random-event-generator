...
The exponential and gaussian distributions are calculated from the uniform distribution using the methods described in D.E. Knuth, *The Art of Computer Programming,* Vol. 2, Sec. 3.4. Samples from an exponential distribution with mean <i>m</i> are given by
<p><div align = "center">
